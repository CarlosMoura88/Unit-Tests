...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Retorna undefined caso o parâmetro passado não seja um número', () => {
    expect(circle('Carol')).toBe(undefined);
  });
  ...
  it('Teste se a função retorna undefine ao não receber parâmetro', () => {
  ...
  it('Teste que a função retorna, num objeto, os dados corretos de um círculo de raio 3', () => {
    const resultado = { radius: 3, area: 28.259999999999998, circumference: 18.84 };
    expect(circle(3)).toEqual(resultado);
  });
});
